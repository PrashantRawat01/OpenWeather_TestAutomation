...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/testng-results">
        ...
        <xsl:call-template name="navigationFile">
			...
			<xsl:with-param name="reporterOutputElement" select="ReportNG-output"/>
        </xsl:call-template>
		...
		<!-- ReportNg output file -->
        <xsl:result-document href="{testng:absolutePath('index.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                <xsl:call-template name="htmlHead"/>
                <body>
                    <h2>ReportNG output</h2>
                    <xsl:for-each select="ReportNG-output/line">
                        <div>
                            <code>
                                <xsl:value-of select="."/>
                            </code>
            ...
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
                    ...
                    <div>
					 ...
					 <div>
                        <a href="file:///C:/Users/rawatp1/Desktop/CO/Selenium_Prac/Selenium_webdriver_project/reports/ReportNG/html/index.html" target="content"
                           onclick="javscript:clearAllSelections();">ReportNG output
                        </a>
                    </div>
